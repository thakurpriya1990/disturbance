...
<script>
    ...
    export default {
        ...
        render(h) {
            let vm =this;
            //Renderer.sections = [];
            Renderer.store_status_data(vm.proposal.readonly,vm.proposal.assessor_data,vm.proposal.comment_data,vm.proposal.add_info_applicant,vm.proposal.current_assessor,vm.proposal.assessor_mode,vm.proposal.can_user_edit,vm.proposal.documents_url, vm.proposal.id, vm.proposal.application_type);
