    ...
    def process_document(self, request, *args, **kwargs):
        try:
            ...
            if proposal_lodgement_date and (parser.parse(str(instance.lodgement_date))!=parser.parse(proposal_lodgement_date)):
                ...
                documents = instance.documents.filter(input_name=section, hidden=False, uploaded_date__lte=proposal_lodgement_date)
                ...
                for document in documents:
                    ...
                    if not older_document_version.field_dict['hidden']:
                        ...
                        logger.debug('older_document = ' + str(older_document) + '\n')
