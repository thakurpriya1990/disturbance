...
class ProposalViewSet(viewsets.ModelViewSet):
    ...
    def process_document(self, request, *args, **kwargs):
        try:
            ...
            #logger.debug('proposal_lodgement_date = ' + str(proposal_lodgement_date))
            #logger.debug('instance.lodgement_date = ' + str(instance.lodgement_date))           
            if proposal_lodgement_date and (parser.parse(str(instance.lodgement_date))!=parser.parse(proposal_lodgement_date)):
                ...
                for document in documents:
                    ...
                    #logger.debug('older_document input = ' + str(older_document.input_name))
                    #logger.debug('older_document.hidden = ' + str(older_document.hidden))
                    #logger.debug('older_document._file = ' + str(older_document._file))

                if older_version_documents:
                    logger.debug('older_version_documents = ' + str(older_version_documents) + '\n')
